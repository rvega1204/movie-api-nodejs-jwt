/**
 * @file movieValidators.js
 * @description Zod validation schemas for movie-related requests.
 * Defines rules for creating, updating, and deleting movies.
 */
 ...
 * Ensures mandatory fields like title and releaseYear are present and valid.
 */
 ...
 * All fields are optional, allowing partial updates, but must follow constraints if provided.
 */
...
/**
 * Validation schema for deleting a movie.
 * Requires a valid positive integer ID.
 */
...
export { createMovieSchema, updateMovieSchema, deleteMovieSchema };
